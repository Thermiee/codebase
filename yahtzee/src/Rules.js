...
class SmallStraight extends Rule{
  ...
  evalRoll = dice => {
    ...
    //  straight can be 234 + either 1 0r 5
...
const ones = new TotalOneNumber({ val: 1, description: "2point per 1"});
const twos = new TotalOneNumber({ val: 2, description: "2point per 2" });
const threes = new TotalOneNumber({ val: 3, description: "3point per 3" });
const fours = new TotalOneNumber({ val: 4, description: "4point per 4" });
const fives = new TotalOneNumber({ val: 5, description: "5point per 5" });
const sixes = new TotalOneNumber({ val: 6, description: "6point per 6" });
...
const fullHouse =new FullHouse({score: 25, description: "25points for a full house"})
